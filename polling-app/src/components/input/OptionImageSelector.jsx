...
const OptionImageSelector = ({ imageList, setImageList }) => {
    ...
    const handleAddImage = (event) =>{
        ...
        if(file && ImageTrackList.length < 4){
  ...
  return (
    <div>
        ...
        <div className='grid grid-cols-2 gap-4 mb-4'>
            ...
            <div className='bg-gray-600/10 rounded-md relative'>
               <img  
                 src={item.base64}
                 alt={`Selected_${index}`}
               ...
               />
               <button 
               onClick={() => handleDeleteImage(index)} className='text-red-500 bg-gray-100 rounded-full p-2 absolute top-2 right-2'>
